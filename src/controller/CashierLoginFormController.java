...
public class CashierLoginFormController {
    ...
    public void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgPlaceOrder":
                    mainPane= FXMLLoader.load(this.getClass().getResource("../view/placeOrderForm.fxml"));
                    //setRUI("AdministratorLoginForm");
                    break;
                case "imgManageCustomer":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../view/manageCustomerForm.fxml"));
                    break;
                case "imgSearchOrder":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../view/searchOrderForm.fxml"));
                    break;
