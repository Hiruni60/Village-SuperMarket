...
public class mainFormController {
    ...
    public ImageView imgAdministrator;
        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgAdministrator":
                   mainPane= FXMLLoader.load(this.getClass().getResource("../view/AdministratorLoginForm.fxml"));
                    //setRUI("AdministratorLoginForm");
                    break;
                case "imgCashier":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../view/CashierLoginForm.fxml"));
                    break;
